...
void TestModel() {
    using namespace std;
    static auto agent_features = array<Stack<int, 100>, 4>();
    for (const auto& v : { 16,  128,  306,  421,  521,  597,  620,  651,  672,  697,  759,  888,
           954,  910, 1169, 1262, 1330, 1358, 1369, 1392, 1428, 1478, 1545, 1623,
          1707, 1714, 1719, 1723, 1727, 1731, 1735, 1739, 1743, 1748, 1757, 1776,
          1804, 1844, 1898, 1961, 2029 }) {
    ...
    for (const auto& v : { 50,  128,  272,  421,  523,  599,  622,  651,  672,  692,  750,  895,
           955,  911, 1080, 1267, 1331, 1358, 1368, 1389, 1424, 1475, 1541, 1620,
          1704, 1714, 1719, 1723, 1727, 1731, 1735, 1739, 1743, 1748, 1756, 1773,
          1800, 1841, 1894, 1958, 2026 }) {
        agent_features[3].push(v);
    }
    static auto condition_features = Stack<int, 100>();
    for (const auto& v : { 2104, 2127, 2294 }) {
